...
class Project extends CRMEntity {
	...
	function get_gantt_chart($id, $cur_tab_id, $rel_tab_id, $actions=false){
		...
		while($rec_related_projecttasks = $adb->fetchByAssoc($related_projecttasks)){
            ...
            $rec_related_projecttasks['projecttaskname'] = iconv($default_charset, "UTF-8//TRANSLIT",$rec_related_projecttasks['projecttaskname']);
		...
		while($rec_related_projectmilestones = $adb->fetchByAssoc($related_projectmilestones)){
            ...
            $rec_related_projectmilestones['projectmilestonename'] = iconv($default_charset, "UTF-8//TRANSLIT",$rec_related_projectmilestones['projectmilestonename']);
